...
static unsigned int m0_sleep_gpio_table_rev01[][3] = {
	...
	{EXYNOS4_GPL0(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /*POWER_LED*/
	{EXYNOS4_GPL2(0), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /*GYRO_DE*/
	{EXYNOS4212_GPM0(5), S3C_GPIO_SLP_INPUT, S3C_GPIO_PULL_DOWN}, /*MOT_EN*/
...
static struct m0_sleep_table m0_sleep_table[] = {
	GPIO_TABLE(m0_sleep_gpio_table),	/* Rev0.0(0x0) - GC1 HWREV0.3 */
	GPIO_TABLE(m0_sleep_gpio_table_rev01),	/* Rev0.1(0x1) - GC1 HWREV0.4 */
};
