...
/*
 * We only support 32-bit VA/PA spaces for now.
 */
#define ARM_LPAE_L1PT_INDX(addr) \
   MVP_EXTRACT_FIELD(addr, ARM_LPAE_L1D_BLOCK_ORDER, 2)
#define ARM_LPAE_L2PT_INDX(addr) \
   MVP_EXTRACT_FIELD(addr, ARM_LPAE_L2D_BLOCK_ORDER, ARM_LPAE_PT_ENTRIES_ORDER)
#define ARM_LPAE_L3PT_INDX(addr) \
   MVP_EXTRACT_FIELD(addr, ARM_LPAE_L3D_BLOCK_ORDER, ARM_LPAE_PT_ENTRIES_ORDER)
